      ...
      <div className={`${styles.drawer} ${isOpen ? styles.open : ''}`}>
        ...
        <div className={styles.drawerBody}>
          <div className={styles.quickLinksGrid}>
            ...
            <Link href="/wallet" className={styles.quickLinkCard} onClick={() => setIsOpen(false)}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="5" width="20" height="14" rx="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg>
              <span>Wallet</span>
            </Link>
          </div>
